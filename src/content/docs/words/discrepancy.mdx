...
<Pronunciation word="Discrepancy" uk="/dɪsˈkɹɛpənsi/" us="/dɪsˈkɹɛpənsi/" client:only />
...
<WordRelations
  synonyms={["anomalous", "discordance", "anomaly", "conflict", "contrariety", "deviation", "difference", "disagreement", "disparity", "dissimilarity", "divergence", "incompatibility", "inconsistency", "mismatch", "variance", "variation"]}
  client:only
/>
