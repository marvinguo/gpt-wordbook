...
<WordRelations
  synonyms={["slashed zero", "additive identity", "nadir", "bugger all", "fuck all", "nada", "naught", "nil", "nothing", "nought", "nowt", "null", "sod all", "sweet FA", "sweet Fanny Adams", "zilch", "zip", "cipher", "nobody", "nonentity"]}
  antonyms={["pole"]}
  client:only
/>
