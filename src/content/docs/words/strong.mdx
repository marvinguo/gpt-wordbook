...
<WordRelations
  synonyms={["derf", "forceful", "powerful", "durable", "sturdy", "tough", "ardent", "determined", "swith", "unyielding", "zealous", "irregular", "hard", "concentrated", "potent", "rank", "extreme", "intense", "impregnable", "inviolable"]}
  antonyms={["forceless", "weak", "fragile", "regular", "diluted", "impotent", "forcelessly", "powerlessly", "weakly"]}
  client:only
/>
