...
<WordRelations
  synonyms={["Third World", "developing", "antediluvian", "antiquated", "backwards", "parachronistic", "retrograde", "forepast", "historical", "overdue", "tardy"]}
  antonyms={["First World", "developed", "forward", "progressive", "forwards"]}
  client:only
/>
