...
<WordRelations
  synonyms={["against", "bar", "block", "check", "combat", "confront", "contest", "contradict", "counter", "counterattack", "defiance", "defy", "face", "fight", "fly in the face of", "hinder", "hostile", "make a stand", "obstruct", "opposition"]}
  antonyms={["support"]}
  client:only
/>
