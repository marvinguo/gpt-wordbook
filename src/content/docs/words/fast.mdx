...
<WordRelations
  synonyms={["express", "express train", "quick", "rapid", "speedy", "swift", "easy", "slutty", "ahead", "colour-fast", "deep", "sound", "firm", "immobile", "secure", "stable", "stuck", "tight", "fortified", "impenetrable"]}
  antonyms={["local", "slow train", "stopper", "slow", "behind", "light", "loose", "penetrable", "weak", "lightly", "loosely", "slowly"]}
  client:only
/>
