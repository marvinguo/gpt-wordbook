...
<WordRelations
  synonyms={["big leagues", "program(me)", "demonstration", "illustration", "proof", "exhibition", "exposition", "façade", "front", "superficiality", "display", "exhibit", "indicate", "point out", "reveal", "demonstrate", "prove", "arrive", "show up"]}
