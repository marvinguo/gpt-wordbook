...
<Pronunciation word="exquisite" uk="/ɪkˈskwɪzɪt/" us="/ɪkˈskwɪzɪt/" client:only />
...
<WordRelations 
  synonyms={["beautiful", "elegant", "delicate", "fine", "refined", "superb", "perfect", "flawless", "magnificent", "lovely"]}
  antonyms={["crude", "rough", "coarse", "inferior", "poor", "ugly", "clumsy", "imperfect"]}
  client:only
/>
