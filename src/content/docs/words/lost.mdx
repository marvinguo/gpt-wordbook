...
<WordRelations
  synonyms={["leave behind", "mislay", "forfeit", "drop", "shed", "ditch", "dump", "get rid of", "jettison"]}
  antonyms={["find", "acquire", "come across", "discover", "gain", "get", "pick up", "procure", "snag", "come first", "win", "put on"]}
  client:only
/>
