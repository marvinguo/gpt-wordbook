...
<WordRelations
  synonyms={["crack of dawn", "split", "breach", "gap", "space", "time-out", "day off", "time off", "playtime", "recess", "crack", "fracture", "burst", "bust", "shatter", "shear", "smash", "break down", "fail", "go down"]}
