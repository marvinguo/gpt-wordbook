...
<Pronunciation word="Disability" uk="/dɪsəˈbɪlɪti/" us="/dɪsəˈbɪlɪti/" client:only />
...
<WordRelations
  synonyms={["disqualification", "impotence", "inability", "incapacity", "incompetence", "incompetency", "weakness"]}
  antonyms={["ability", "capacity", "competence", "competency", "potence", "potential", "qualification", "strength"]}
  client:only
/>
