...
<WordRelations
  synonyms={["frank", "sincere", "consarn", "darned", "stinking", "no-frills", "simple", "unadorned", "unseasoned", "normal", "ordinary", "blatant", "ostensible", "monochrome"]}
  antonyms={["bells and whistles", "decorative", "exotic", "fancy", "ornate"]}
  client:only
/>
