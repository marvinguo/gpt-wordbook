...
<Pronunciation word="Abbreviate" uk="/ə.ˈbɹiː.vi.eɪt/" us="/əˈbɹi.vi.eɪt/" client:only />
...
<WordRelations
  synonyms={["abridge", "compress", "condense", "contract", "curtail", "epitomize", "reduce", "shorten"]}
  antonyms={["amplify", "dilate", "elongate", "enlarge", "expand", "expatiate", "extend", "lengthen", "produce", "prolong", "stretch"]}
  client:only
/>
