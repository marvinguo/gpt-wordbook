...
<WordRelations
  synonyms={["idiot", "imbecile", "learning difficulties", "mental deficient", "moron", "retarded", "tard", "delay", "hold-up", "retardation", "decelerate", "slow", "slow down", "slow up", "hinder", "postpone", "put off", "reluctant", "hang back", "stay back"]}
  antonyms={["accelerate", "speed", "speed up", "come forward"]}
  client:only
/>
