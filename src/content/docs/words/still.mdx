...
<WordRelations
  synonyms={["lull", "quiet", "respite", "rest", "tranquility", "Benny", "Falklander", "Kelper", "hushed", "tranquil", "incessant", "ongoing", "unremitting", "flat", "uneffervescent", "fixed", "inert", "stagnant", "static", "stationary"]}
  client:only
/>
