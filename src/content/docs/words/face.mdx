...
<WordRelations
  synonyms={["countenance", "expression", "facial expression", "look", "visage", "facet", "surface", "phiz", "phizog", "image", "public image", "reputation", "cakehole", "gob", "mush", "piehole", "trap", "good guy", "hero", "foreside"]}
  antonyms={["heel"]}
  client:only
/>
