...
<WordRelations
  synonyms={["assume", "bear", "pay for", "use up", "assimilate", "engulf", "incorporate", "overwhelm", "swallow up", "engage", "engross", "immerse", "monopolize", "occupy", "draw", "drink in", "imbibe", "soak up", "sop up", "steep"]}
  antonyms={["emit"]}
  client:only
/>
