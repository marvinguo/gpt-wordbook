...
<WordRelations
  synonyms={["musical", "one of the family", "one of them", "that way inclined", "correct", "right", "true", "like", "this", "thus", "much", "really", "truly", "very", "that", "yea", "so that", "hey", "look", "see"]}
  client:only
/>
