...
<WordRelations
  synonyms={["eld", "mzee", "senior", "antecessor", "forerunner", "erstwhile", "ex-", "former", "one-time", "past", "ancient", "long in the tooth", "aged", "of age", "ageing", "aging", "elderly", "on in years", "antiquated", "obsolete"]}
  antonyms={["current", "latest", "new", "brand new", "fresh", "young"]}
  client:only
/>
