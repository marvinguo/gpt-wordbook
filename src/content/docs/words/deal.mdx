...
<WordRelations
  synonyms={["allotment", "apportionment", "distribution", "doling out", "sharing", "batch", "flock", "good deal", "great deal", "hatful", "heap", "load", "lot", "mass", "mess", "mickle", "mint", "muckle", "peck", "pile"]}
  client:only
/>
