...
<Pronunciation word="Privilege" uk="/ˈpɹɪv(ɪ)lɪdʒ/" us="/ˈpɹɪv(ɪ)lɪdʒ/" client:only />
...
<WordRelations
  synonyms={["advantage", "foredeal", "claim", "liberty", "franchise", "freelage", "immunity", "prerogative", "right", "permission"]}
  client:only
/>
