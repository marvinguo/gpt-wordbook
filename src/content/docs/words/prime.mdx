...
<WordRelations
  synonyms={["prime number", "choice", "prize", "quality", "select", "bloom", "blossom", "efflorescence", "flower", "flush", "heyday", "peak", "indivisible", "earliest", "first", "original", "excellent", "top quality", "greatest", "main"]}
  antonyms={["composite"]}
  client:only
/>
