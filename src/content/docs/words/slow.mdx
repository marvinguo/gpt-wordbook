...
<WordRelations
  synonyms={["decelerate", "slacken", "delay", "hinder", "retard", "careful", "deliberate", "prudent", "boring", "dilatory", "dull", "inactive", "slothful", "sluggish", "tardy", "quiet", "unbusy", "gradual", "dull-witted", "moderate"]}
  antonyms={["hasty", "precipitate", "prompt", "accurate", "fast", "brisk", "lively", "hectic", "abrupt", "sudden", "keen", "quick", "quick-witted", "rapid", "swift"]}
  client:only
/>
