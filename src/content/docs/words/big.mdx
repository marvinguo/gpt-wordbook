...
<WordRelations
  synonyms={["major leagues", "adult", "fully grown", "grown up", "all the rage", "in demand", "well liked", "ample", "huge", "jumbo", "large", "massive", "sizeable", "stoor", "busty", "macromastic", "stacked", "chubby", "plus-size", "rotund"]}
