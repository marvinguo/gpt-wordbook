...
<WordRelations
  synonyms={["drag", "toke", "tug", "yank", "attraction", "handle", "knob", "lever", "rope", "influence", "sway", "tow", "score", "carry out", "complete", "do", "execute", "perform", "recall", "withdraw"]}
  antonyms={["push", "shove", "repulsion", "button", "push-button", "repel"]}
  client:only
/>
