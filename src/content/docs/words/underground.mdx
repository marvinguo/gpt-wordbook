...
<WordRelations
  synonyms={["Métro", "metro", "Tube", "tube", "rapid transit", "underground", "underground railway", "underpass", "avant-garde", "counterculture", "resistance", "alternative", "unconventional", "hypogean", "subterranean", "below ground", "clandestinely", "in secret", "on the quiet"]}
  antonyms={["mainstream"]}
  client:only
/>
