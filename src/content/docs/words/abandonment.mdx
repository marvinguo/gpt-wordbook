...
<Pronunciation word="Abandonment" uk="/əˈbæn.dn̩.mn̩t/" us="/əˈbæn.dn̩.mn̩t/" client:only />
...
<WordRelations
  ...
  antonyms={["acquisition", "arrogation", "care", "completion", "conviviality", "correction", "custody", "entertainment", "heed", "help", "hospitality", "maintenance", "reception", "reclamation", "retention", "solicitude", "support", "tenacity", "vigilance", "watchfulness"]}
  client:only
/>
