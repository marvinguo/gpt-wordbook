...
<WordRelations
  synonyms={["broad", "chummy", "close", "close-knit", "friendly", "intimate", "pally", "tight-knit", "chunky", "solid", "stocky", "thickset", "crowded", "dense", "packed", "dumb", "stupid", "thick as pigshit", "thick as two short planks", "opaque"]}
  antonyms={["brainy", "intelligent", "smart", "free-flowing", "runny", "scant", "scarce", "slight", "slender", "slim", "svelte", "thin", "sparse", "transparent", "unacquainted"]}
  client:only
/>
