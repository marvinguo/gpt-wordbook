...
<WordRelations
  synonyms={["enlargement", "expansion", "gain", "increment", "raise", "rise", "go up", "grow", "shoot up", "soar", "wax", "up", "proliferate", "propagate", "teem"]}
  antonyms={["decline", "decrease", "diminishment", "cut", "decrement", "drop", "fall", "loss", "lowering", "reduction", "shrinkage", "go down", "plummet", "plunge", "reduce", "shrink", "sink", "lower", "wane"]}
  client:only
/>
