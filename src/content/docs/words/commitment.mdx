...
<WordRelations
  synonyms={["allegiance", "charge", "committal", "consignment", "dedication", "devoir", "duty", "engagement", "guarantee", "liability", "loyalty", "must", "need", "oath", "obligation", "ought", "pledge", "promise", "responsibility", "undertaking"]}
  client:only
/>
