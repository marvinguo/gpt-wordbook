...
<WordRelations
  synonyms={["bun in the oven", "eating for two", "in a family way", "knocked up", "preggers", "up the duff", "up the spout", "interesting condition", "expectant", "expecting", "fertilized", "gravid", "with child", "meaningful", "significant"]}
  client:only
/>
