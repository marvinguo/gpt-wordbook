...
<WordRelations
  synonyms={["curious", "eccentric", "funny", "odd", "peculiar", "rum", "rummy", "strange", "unusual", "exceptional", "extraordinary", "remarkable", "individual", "non-invertible", "unique"]}
  antonyms={["plural", "general", "invertible", "non-singular"]}
  client:only
/>
