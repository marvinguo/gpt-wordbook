...
<WordRelations
  synonyms={["endure", "resist", "cancel", "cease", "discontinue", "halt", "stop", "terminate", "blin", "brake", "desist", "continue", "keep", "remain", "break a lance", "contend", "stand firm", "take a stand", "bear", "prop up"]}
  client:only
/>
