...
<Pronunciation word="Actual" uk="/ˈak(t)ʃj(ʊ)əl/" us="/ˈæk(t)ʃ(əw)əl/" client:only />
...
<WordRelations
  ...
  antonyms={["conceivable", "estimated", "hypothetical", "nominal", "possible", "potential", "speculative", "theoretical", "virtual", "future", "past"]}
  client:only
/>
