...
<Pronunciation word="Procedure" uk="/pɹəˈsiːdʒə/" us="/pɹəˈsidʒɚ/" client:only />
...
<WordRelations
  synonyms={["function", "method", "routine", "sub", "subroutine", "operation", "algorithm", "process", "protocol"]}
  client:only
/>
