...
<WordRelations
  synonyms={["relocation", "removal", "play", "actuate", "affect", "trouble", "agitate", "get moving", "stir", "impel", "incite", "incline", "induce", "influence", "instigate", "offer", "persuade", "prompt", "propose", "rouse"]}
  client:only
/>
