...
<WordRelations
  synonyms={["brain", "head", "intellect", "intelligence", "nous", "psyche", "reason", "wit", "awareness", "consciousness", "sentience", "attention", "concentration", "focus", "memory", "recollection", "desire", "disposition", "idea", "inclination"]}
  client:only
/>
