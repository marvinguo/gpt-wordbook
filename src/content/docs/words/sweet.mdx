...
<WordRelations
  synonyms={["dessert", "bonbon", "candy", "confection", "confectionery", "lolly", "sweetness", "awesome", "rad", "wicked", "sugared", "sweetened", "gracious", "helpful", "kind", "sensitive", "thoughtful", "fragrant", "odoriferous", "odorous"]}
  antonyms={["lame", "uncool", "nonsweet", "sugarless", "unsugared", "unsweet", "unsweetened", "sour", "bitter", "salty", "decaying", "fermented", "rancid", "spoiled", "stale", "savoury", "dry"]}
  client:only
/>
