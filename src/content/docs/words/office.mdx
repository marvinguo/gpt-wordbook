...
<WordRelations
  synonyms={["Divine Office", "Liturgy of the Hours", "breviary", "canonical hours", "liturgy of the hours", "surgery", "bureau", "department", "ministry", "divine service", "liturgy", "religious service", "service"]}
  client:only
/>
