...
<Pronunciation word="Stranger" uk="/ˈstɹeɪndʒə/" us="/ˈstɹeɪndʒɚ/" client:only />
...
<WordRelations
  ...
  antonyms={["everyday", "normal", "regular", "standard", "unsurprising", "usual", "familiar", "known", "citizen", "compatriot", "countryman", "fellow", "national", "resident", "acquaintance", "friend"]}
  client:only
/>
