...
<Pronunciation word="Anxiety" uk="/ˌæŋ(ɡ)ˈzaɪ.ə.ti/" us="/ˌæŋ(ɡ)ˈzaɪ.ə.ti/" client:only />
...
<WordRelations
  synonyms={["apprehension", "care", "disquiet", "disquietude", "distress", "foreboding", "perplexity", "restlessness", "solicitude", "trouble", "uneasiness"]}
  client:only
/>
