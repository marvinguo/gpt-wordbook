...
<WordRelations
  synonyms={["extant", "live", "vital", "hotheaded", "rattish", "short-tempered", "snippish", "snippy", "bright", "droll", "keen", "fluent", "fluminous", "fast", "rapid", "speedy", "swift", "brief", "momentary", "short-lived"]}
  antonyms={["slow"]}
  client:only
/>
