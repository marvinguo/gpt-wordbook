...
<WordRelations
  synonyms={["carpenter's square", "framing square", "steel square", "hash", "pound sign", "sharp", "piazza", "plaza", "tetragon", "above board", "on the level", "on the square", "on the up and up", "straight", "bourgeois", "normal", "orthogonal", "perpendicular"]}
  antonyms={["crooked"]}
  client:only
/>
