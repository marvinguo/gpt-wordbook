...
<WordRelations
  synonyms={["damn right", "damn straight", "fo shizzle", "for sure", "oh yeah", "wye aye", "absolutely", "beyond doubt", "indubitably", "sure thing", "undoubtedly", "wis", "without a doubt", "definitely", "doubtlessly", "in fact", "indeed", "indisputably", "no doubt", "really"]}
  client:only
/>
