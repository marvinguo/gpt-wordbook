...
<WordRelations
  synonyms={["contract", "cut short", "decrease", "diminish", "lessen", "lower", "moderate", "remit", "remove", "slacken", "suppress", "terminate", "appease", "depress", "humble", "pacify", "soften", "soothe", "tranquilize", "fail"]}
