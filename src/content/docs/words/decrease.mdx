...
<WordRelations
  synonyms={["cut", "decrement", "drop", "fall", "loss", "lowering", "reduction", "shrinkage", "go down", "plummet", "plunge", "reduce", "shrink", "sink", "abate", "lower"]}
  antonyms={["gain", "increase", "increment", "raise", "rise", "go up", "grow", "shoot up", "soar", "up"]}
  client:only
/>
