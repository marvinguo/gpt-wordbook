...
<Pronunciation word="Separation" uk="/sɛpəˈɹeɪʃən/" us="/sɛpəˈɹeɪʃən/" client:only />
...
<WordRelations
  synonyms={["barrier", "separator", "border", "boundary", "demarcation", "break", "interstice", "detachment", "disjunction", "division", "rupture", "severance"]}
