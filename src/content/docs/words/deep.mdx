...
<WordRelations
  synonyms={["heavy", "meaningful", "profound", "low", "low-pitched", "bright", "rich", "vivid", "fast", "thick", "great", "large", "voluminous"]}
  antonyms={["frivolous", "light", "shallow", "superficial", "high", "high-pitched", "piping", "desaturated", "pale", "washed-out", "thin", "small"]}
  client:only
/>
