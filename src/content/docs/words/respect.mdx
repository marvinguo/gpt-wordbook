...
<WordRelations
  synonyms={["admiration", "esteem", "honor", "recognition", "regard", "reverence", "veneration", "aspect", "dimension", "face", "facet", "side", "aught", "consideration", "deference", "fealty", "revere", "venerate", "value"]}
  antonyms={["belittlement", "contempt", "contumely", "despect", "disdain", "disparagement", "disrespect", "ignoring", "irreverence", "neglect", "scorn", "slight", "contemn", "despise", "dis", "diss", "belittle", "ignore"]}
  client:only
/>
