...
<WordRelations
  synonyms={["bygone", "foregone", "dated", "old-fangled", "outdated", "groundbreaking", "important", "landmark", "momentous", "notable", "significant", "ancient", "former", "old", "past", "historial", "historic"]}
  antonyms={["unhistoric", "ahistorical", "anachronistic", "expected", "future", "projected", "contemporary", "modern", "present", "present-day"]}
  client:only
/>
