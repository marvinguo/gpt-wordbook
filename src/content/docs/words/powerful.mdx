...
<WordRelations
  synonyms={["forceful", "mightful", "mighty", "powersome", "strengthful", "strong", "eminently", "ever so", "main", "sore", "swith", "way too", "actually", "authentically", "truly", "drastically", "extremely", "greatly"]}
