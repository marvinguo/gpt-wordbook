...
<WordRelations
  synonyms={["even so", "nevertheless", "notwithstanding", "yet", "barring", "except for", "save for", "bar", "excepting", "excluding", "unless", "with the exception of", "without", "ac", "although"]}
  client:only
/>
