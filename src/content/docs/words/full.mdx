...
<WordRelations
  synonyms={["complete", "thorough", "abounding", "brimful", "bursting", "chock-a-block", "chock-full", "full up", "jam full", "jam-packed", "jammed", "laden", "loaded", "overflowing", "packed", "rammed", "stuffed", "baggy", "big", "large"]}
  antonyms={["incomplete", "empty", "close-fitting", "small", "tight", "tight-fitting", "hungry", "starving", "partial"]}
  client:only
/>
