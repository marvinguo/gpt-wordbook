...
<WordRelations
  synonyms={["account", "answer", "comeback", "reaction", "rejoinder", "response", "retort", "return", "riposte", "answer back", "counter", "follow up", "get back to", "react", "rejoin", "respond", "revert"]}
  client:only
/>
