...
<Pronunciation word="Astonishment" uk="/əˈstɒnɪʃmənt/" us="/əˈstɑːnɪʃmənt/" client:only />
...
<WordRelations
  synonyms={["amazement", "stupefaction", "wonder", "wonderment", "consternation", "dismay", "marvel", "stunner", "numbness", "paralysis", "stupor"]}
  client:only
/>
