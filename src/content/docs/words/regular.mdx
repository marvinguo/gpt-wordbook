...
<WordRelations
  synonyms={["frequenter", "habitué", "patron", "usual suspects", "absolute", "thorough", "unalloyed", "basic", "common", "unremarkable", "chaotic", "in order", "ruly", "tidy", "tumultuous", "cyclical", "frequent", "decent", "seemly", "well-mannered"]}
  antonyms={["non-regular", "nonregular", "chaotic", "irregular", "degenerate", "goofy", "noncyclic", "outlandish", "weird", "strong"]}
  client:only
/>
