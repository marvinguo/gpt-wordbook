...
<Pronunciation word="Apparatus" uk="/æpəˈɹɑːtəs/" us="/æ.pəˈɹæ.təs/" client:only />
...
<WordRelations
  synonyms={["device", "instrument", "machinery", "dynamic", "mechanism", "setup", "equipment", "gear", "tools", "machine"]}
  client:only
/>
