...
<WordRelations
  synonyms={["accepting", "approval", "receiving", "reception", "assent", "acceptableness", "AΩ product", "acceptance", "geometric extent", "light grasp", "light-collecting power", "light-gathering power", "optical extent", "throughput"]}
  client:only
/>
