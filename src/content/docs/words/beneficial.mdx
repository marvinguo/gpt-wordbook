...
<Pronunciation word="Beneficial" uk="/ˌbɛnəˈfɪʃəl/" us="/ˌbɛnəˈfɪʃəl/" client:only />
...
<WordRelations
  synonyms={["advantageous", "behooveful", "helpful", "useful", "usufructuary", "usufructuous"]}
  antonyms={["damaging", "harmful", "maleficial", "nocuous", "harmless", "innocuous", "undamaging"]}
  client:only
/>
