...
<WordRelations
  synonyms={["busybody", "gossipmonger", "meddler", "rumormonger", "chat", "chinwag", "chit-chat", "natter", "dirt", "hearsay", "rumor", "scandal", "scuttlebutt", "friend", "sponsor", "blab", "dish the dirt", "spill the tea", "talk out of turn", "tell tales out of school"]}
  client:only
/>
