...
<Pronunciation word="Designate" uk="/ˈdɛzɪɡ.neɪt/" us="/ˈdɛzɪɡ.neɪt/" client:only />
...
<WordRelations
  synonyms={["denominate", "entitle", "name", "style", "denote", "describe", "indicate", "note", "allocate", "earmark"]}
  client:only
/>
