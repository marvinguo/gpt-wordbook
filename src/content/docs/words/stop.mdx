...
<WordRelations
  synonyms={["occlusive", "plosive", "arrest", "freeze", "halt", "blin", "cancel", "cease", "discontinue", "terminate", "brake", "desist", "lodge", "stop over", "hang about", "hang around", "linger", "loiter", "pause"]}
