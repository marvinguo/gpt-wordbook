...
<WordRelations
  synonyms={["by and large", "commonly", "for the most part", "generally", "in the main", "mainly", "most often", "mostly", "on the whole", "ordinarily", "regularly", "wontedly", "as a rule", "customarily", "habitually", "normally", "routinely", "wontly"]}
  client:only
/>
