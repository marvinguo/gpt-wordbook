...
<WordRelations
  synonyms={["button", "stag", "hob", "hob-ferret", "billy", "billygoat", "buck-goat", "buckling", "he-goat", "ram", "tup", "bill", "bone", "clam", "cucumber", "dead president", "greenback", "note", "one-spot", "paper"]}
  client:only
/>
