...
<WordRelations
  synonyms={["fire", "shoot", "free", "release", "loosen", "relax", "slacken", "let go", "unbind", "undo", "unfasten", "untie", "indiscreet", "untethered", "diffuse", "spaced out", "baggy", "unfastened", "unsecured", "separate"]}
  antonyms={["fast", "bind", "constrain", "tighten", "fasten", "tie", "discreet", "bound", "leashed", "tethered", "tied", "tied up", "compact", "firm", "close-fitting", "snug", "tight", "packaged", "faithful", "monogamous"]}
  client:only
/>
