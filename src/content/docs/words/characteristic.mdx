...
<Pronunciation word="Characteristic" uk="/ˌkæɹəktəˈɹɪstɪk/" us="/ˌkæɹəktəˈɹɪstɪk/" client:only />
...
<WordRelations
  synonyms={["attribute", "hallmark", "idiosyncrasy", "mannerism", "quality", "tendency", "trademark", "trait", "distinctive", "exclusive", "idiosyncratic", "indicative", "representative", "signature", "specific", "typical"]}
