...
<WordRelations
  synonyms={["control", "guidance", "management", "bearing", "behavior", "behaviour", "demeanor", "demeanour", "deportment", "action", "plot", "storyline", "belead", "direct", "lead", "manage", "oversee", "run", "supervise", "accompany"]}
  client:only
/>
