...
<WordRelations
  synonyms={["appellative", "epicene", "mutual", "shared", "widespread", "common-or-garden", "everyday", "normal", "ordinary", "standard", "usual", "common parlance"]}
  antonyms={["individual", "peculiar", "personal", "few and far between", "rare", "uncommon", "exceptional", "extraordinary", "noteworthy", "special", "technical term"]}
  client:only
/>
