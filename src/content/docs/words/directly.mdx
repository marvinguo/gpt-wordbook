...
<WordRelations
  synonyms={["accurately", "precisely", "slap bang", "forthwith", "now", "tout de suite", "straightwise", "undeviatingly", "betimes", "presently", "shortly", "frankly", "truthfully", "bluntly", "clearly", "downrightly", "unambiguously"]}
  antonyms={["indirectly"]}
  client:only
/>
