...
<WordRelations
  synonyms={["bag", "poke", "tote", "hay", "rack", "pink slip", "the axe", "the boot", "the chop", "the elbow", "the old heave-ho", "loot", "ransack", "axe", "can", "dismiss", "fire", "give the boot", "give the chop", "give the elbow"]}
  client:only
/>
