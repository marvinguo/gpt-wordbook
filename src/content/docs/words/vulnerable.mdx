...
<Pronunciation word="Vulnerable" uk="/ˈvʌln(ə)ɹəbl̩/" us="/ˈvʌln(ə)ɹəbl̩/" client:only />
...
<WordRelations
  synonyms={["defenceless", "helpless", "powerless", "unguarded", "unprotected", "weak"]}
  antonyms={["durable", "indomitable", "invincible", "invulnerable", "powerful", "strong"]}
  client:only
/>
