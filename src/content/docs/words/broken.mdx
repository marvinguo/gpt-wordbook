...
<WordRelations
  synonyms={["crack", "fracture", "burst", "bust", "shatter", "shear", "smash", "split", "break down", "fail", "go down", "contravene", "go against", "violate", "break in", "subject", "tame", "rekt", "intermittent", "spasmodic"]}
  antonyms={["hold", "assemble", "fix", "join", "mend", "put together", "repair"]}
  client:only
/>
