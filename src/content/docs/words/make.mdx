...
<WordRelations
  synonyms={["making", "manufacture", "manufacturing", "production", "brand", "manufacturer", "type", "actuation", "closing", "completion", "construction", "origin", "character", "disposition", "makeup", "way", "output", "ID", "identification", "lay"]}
  client:only
/>
