...
<WordRelations
  synonyms={["be no more", "bite the big one", "bite the dust", "buy the farm", "cease to be", "check out", "cross over", "cross the river", "expire", "give up the ghost", "go to meet one's maker", "hop off the twig", "join the choir invisible", "kick the bucket", "pass", "pass away", "pass on", "push up the daisies", "shuffle off this mortal coil", "stiff"]}
  client:only
/>
