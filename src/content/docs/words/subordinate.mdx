...
<WordRelations
  synonyms={["inferior", "junior", "report", "underling", "understrapper", "belittle", "denigrate", "dependent", "lesser"]}
  antonyms={["boss", "commander", "leader", "manager", "superior", "supervisor", "independent", "main", "insubordinate", "superordinate"]}
  client:only
/>
