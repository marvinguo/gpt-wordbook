...
<WordRelations
  synonyms={["bottoms up", "chin chin", "down the hatch", "here’s mud in your eye", "skoal", "bye", "catch you later", "cheerio", "laters", "see you", "see you after", "see you later", "see you later alligator", "so long", "ta-ta", "ta", "thanks"]}
  antonyms={["boo"]}
  client:only
/>
