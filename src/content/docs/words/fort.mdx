...
<WordRelations
  synonyms={["bastion", "bulwark", "bunker", "castle", "citadel", "donjon", "fortification", "fortress", "foxhole", "keep", "motte and bailey", "rampart", "stronghold", "air base", "armory", "arsenal", "base", "camp", "headquarters", "supply depot"]}
  client:only
/>
