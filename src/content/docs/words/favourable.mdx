...
<Pronunciation word="Favourable" uk="/ˈfeɪv(ə)ɹəbəl/" us="/ˈfeɪv(ə)ɹəbəl/" client:only />
...
<WordRelations
  synonyms={["advantageous", "helpful", "useful", "approving", "encouraging", "good", "pleasing", "auspicious", "fortunate", "lucky", "convenient", "handy", "opportune", "suitable"]}
  antonyms={["bad", "discouraging", "displeasing", "unfavorable", "inconvenient", "inopportune", "unsuitable", "inauspicious", "unfavourable", "unlucky", "unhelpful"]}
  client:only
/>
