...
<WordRelations
  synonyms={["abridgment", "compendium", "epitome", "synopsis", "abridge", "epitomize", "summarize", "filch", "purloin", "steal", "remove", "separate", "take away", "withdraw", "abstruse", "ascriptive", "attributive", "conceptual", "ideal", "imaginary"]}
