...
<WordRelations
  synonyms={["spook", "spy", "glimmer", "glimmering", "glimpse", "hint", "inkling", "phantom", "spark", "suggestion", "echo", "ghostwriter", "shadow", "backup", "essence", "soul", "spirit", "apparition", "bogey", "haint"]}
  client:only
/>
