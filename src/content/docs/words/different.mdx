...
<Pronunciation word="Different" uk="/ˈdɪf.(ə)ɹ.ənt/" us="/ˈdɪf.(ə)ɹ.ənt/" client:only />
...
<WordRelations
  synonyms={["apart", "distinct", "other", "aberrant", "deviant", "nonstandard", "sundry"]}
  antonyms={["undifferent", "coherent", "indistinct", "unified", "alike", "identical", "same", "similar", "normal", "usual", "homogeneous"]}
  client:only
/>
