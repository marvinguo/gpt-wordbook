...
<WordRelations
  synonyms={["effulgence", "radiance", "radiancy", "refulgence", "refulgency", "luster", "brilliance", "splendor", "shoeshine", "moonshine", "sunshine", "excel", "beam", "glow", "radiate", "buff", "burnish", "furbish", "polish", "wax"]}
  client:only
/>
