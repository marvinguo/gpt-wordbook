...
<WordRelations
  synonyms={["dodgy", "doubtful", "dubious", "suspect", "suspicious", "fetid", "foul-smelling", "malodorous", "rank", "stinky", "whiffy"]}
  antonyms={["above board", "clean", "aromatic", "fragrant", "sweet-smelling"]}
  client:only
/>
