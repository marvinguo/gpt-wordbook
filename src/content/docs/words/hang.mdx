...
<WordRelations
  synonyms={["put up", "gallows", "swing", "take a ride to Tyburn", "dangle", "suspended", "suspend", "freeze", "lock up", "bedeck", "deck", "decorate", "lynch", "string up", "exhibit", "show", "float", "hover", "drop", "lower"]}
  client:only
/>
