...
<Pronunciation word="Inevitable" uk="/ɪnˈɛvɪtəbəl/" us="/ɪnˈɛvɪtəbəl/" client:only />
...
<WordRelations
  synonyms={["certain", "necessary", "impreventable", "inescapable", "unavoidable", "natural"]}
  antonyms={["evitable", "impossible", "incidental", "avoidable", "escapable", "preventable"]}
  client:only
/>
