...
<WordRelations
  synonyms={["descent", "drop", "rap", "downfall", "decrease", "dip", "lowering", "reduction", "autumn", "back end", "harvest", "responsibility", "up to", "become", "get", "come down", "descend", "lower", "prostrate", "die"]}
  antonyms={["ascent", "rise", "increase", "ascend", "go", "get up", "pick oneself up", "stand up", "beat", "defeat", "overthrow", "smite", "vanquish"]}
  client:only
/>
