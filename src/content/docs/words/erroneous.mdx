...
<Pronunciation word="Erroneous" uk="/ɛɹˈəʊ.nɪ.əs/" us="/ɛɹˈəʊ.nɪ.əs/" client:only />
...
<WordRelations
  synonyms={["inaccurate", "incorrect", "wrong", "fallacious", "false", "faulty", "flawed", "mistaken", "errorful", "errorous", "errory"]}
  antonyms={["errorless"]}
  client:only
/>
