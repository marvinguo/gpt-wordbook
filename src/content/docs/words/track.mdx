...
<WordRelations
  synonyms={["area", "parcel", "region", "tract", "athletics", "track and field", "course", "path", "trajectory", "way", "racetrack", "footprint", "impression", "groove", "ground", "pitch", "road", "rails", "railway", "tracks"]}
  client:only
/>
