...
<Pronunciation word="Familiar" uk="/fəˈmɪl.i.ə/" us="/fəˈmɪl.i.ɚ/" client:only />
...
<WordRelations
  synonyms={["nigget", "acquainted", "cheeky", "fresh", "impudent", "close", "friendly", "intimate", "personal"]}
  antonyms={["unacquainted", "cold", "cool", "distant", "impersonal", "standoffish", "unfriendly", "unfamiliar", "unknown"]}
  client:only
/>
