...
<Pronunciation word="Accessory" uk="/ækˈsɛs(ə)ɹi/" us="/ækˈsɛsəɹi/" client:only />
...
<WordRelations
  synonyms={["acceding", "accompanying", "additional", "auxiliary", "contributory", "subservient", "subsidiary"]}
  client:only
/>
