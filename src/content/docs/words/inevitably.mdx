...
<Pronunciation word="Inevitably" uk="/ɪˈnɛvətəbli/" us="/ɪˈnɛvətəbli/" client:only />
...
<WordRelations
  synonyms={["always", "predictably", "regularly", "certainly", "inexorably", "necessarily", "unavoidably"]}
  antonyms={["unexpectedly", "unusually", "avoidably", "evitably", "impossibly", "incidentally"]}
  client:only
/>
