...
<Pronunciation word="Discourse" uk="/dɪsˈkɔː(ɹ)s/" us="/dɪsˈkɔː(ɹ)s/" client:only />
...
<WordRelations
  synonyms={["communication", "expression", "dissertation", "lecture", "study", "treatise", "ratiocination", "conversation", "debate", "discussion", "talk", "converse"]}
  client:only
/>
