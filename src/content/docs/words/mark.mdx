...
<WordRelations
  synonyms={["Mk", "Mk.", "heed", "observance", "blemish", "scar", "scratch", "stain", "characterize", "typify", "classify", "mark out", "commemorate", "solemnize", "demonstrate", "indicate", "manifest", "reveal", "show", "signal"]}
  client:only
/>
