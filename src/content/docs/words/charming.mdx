...
<Pronunciation word="Charming" uk="/ˈtʃɑː(ɹ).mɪŋ/" us="/ˈtʃɑː(ɹ).mɪŋ/" client:only />
...
<WordRelations
  synonyms={["delight", "enchant", "entrance", "bewitch", "ensorcel", "enspell", "charismatic", "smart", "witty"]}
