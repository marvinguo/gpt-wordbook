...
<WordRelations
  synonyms={["calmness", "composure", "OK", "acceptable", "all right", "chilly", "distant", "phlegmatic", "standoffish", "unemotional", "easy", "fine", "not bothered", "not fussed", "fashionable", "happening", "hip", "in", "in fashion", "modish"]}
  antonyms={["awkward", "uncool", "bothered", "upset", "démodé", "old hat", "out", "out of fashion", "lukewarm", "tepid", "warm", "not cricket", "not on", "unacceptable", "passionate"]}
  client:only
/>
