...
<WordRelations
  synonyms={["approval", "endorsement", "go-ahead", "green light", "thumbs up", "approve", "greenlight", "all right", "allowed", "permissible", "fine", "well", "adequate", "not bad", "satisfactory", "adequately", "satisfactorily", "'kay", "A-OK", "k"]}
  antonyms={["forbidden", "ill", "poorly", "sick", "under the weather", "unwell", "bad", "inadequate", "poor", "unsatisfactory", "badly", "inadequately", "unsatisfactorily"]}
  client:only
/>
