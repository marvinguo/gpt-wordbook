...
<WordRelations
  synonyms={["electric current", "flow", "stream", "tendency", "fashionable", "prevailing", "prevalent", "rife", "up-to-date", "present", "speeding"]}
  antonyms={["future", "past", "out-of-date", "unfashionable"]}
  client:only
/>
