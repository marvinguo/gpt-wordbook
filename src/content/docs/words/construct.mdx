...
<WordRelations
  synonyms={["concept", "idea", "model", "notion", "representation", "assemble", "build", "form", "make", "produce", "put together"]}
  antonyms={["destroy", "disassemble", "dismantle", "ruin", "take apart", "wreck"]}
  client:only
/>
