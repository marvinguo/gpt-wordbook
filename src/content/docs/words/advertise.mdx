...
<Pronunciation word="Advertise" uk="/ˈadvə(ɹ)taɪz/" us="/ˈadvə(ɹ)taɪz/" client:only />
...
<WordRelations
  synonyms={["promote", "publicise", "sell", "announce", "proclaim", "promulgate", "publish", "alert", "apprise", "inform", "notify"]}
  client:only
/>
