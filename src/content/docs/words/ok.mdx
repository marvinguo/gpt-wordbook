...
<WordRelations
  synonyms={["all right", "allowed", "permissible", "fine", "well", "adequate", "not bad", "satisfactory"]}
  antonyms={["forbidden", "ill", "poorly", "sick", "under the weather", "unwell", "bad", "inadequate", "poor", "unsatisfactory"]}
  client:only
/>
