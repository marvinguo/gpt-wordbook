...
<WordRelations
  synonyms={["av.", "ave.", "avg.", "expectation", "mean", "comme ci comme ça", "mediocre", "medium", "middle", "middling", "ranking", "so-so", "unremarkable", "ordinary", "uninspiring", "bog-standard", "conventional", "normal", "regular", "standard"]}
