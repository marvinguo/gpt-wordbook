...
<WordRelations
  synonyms={["development", "maturation", "enlargement", "expansion", "increase", "increment", "cancer", "mass", "outgrowth", "vegetation"]}
  antonyms={["nondevelopment", "contraction", "decrease", "decrement", "reduction"]}
  client:only
/>
