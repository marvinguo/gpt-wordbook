...
<Pronunciation word="Reinforce" uk="/ˌɹiːɪnˈfɔː(ɹ)s/" us="/ˌɹiːɪnˈfɔː(ɹ)s/" client:only />
...
<WordRelations
  synonyms={["emphasize", "repeat", "review", "encourage", "instruct", "learn", "reward", "teach", "augment", "bolster", "buttress", "fortify", "line", "strengthen"]}
  client:only
/>
