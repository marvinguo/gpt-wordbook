...
<WordRelations
  synonyms={["leap", "flinch", "jerk", "twitch", "ambush", "assail", "jump down", "jump off", "skydive", "hump", "jump someone's bones", "beat it", "rabbit", "take off", "skip", "spring", "jump out of one's skin", "leap out of one's skin", "accurately", "just"]}
  client:only
/>
