...
<WordRelations
  synonyms={["agreement", "approval", "assent", "consensualness", "permission", "willingness", "yes", "acquiesce", "agree", "approve", "concur"]}
  antonyms={["disagreement", "dissent", "opposition", "refusal", "disagree", "object", "oppose"]}
  client:only
/>
