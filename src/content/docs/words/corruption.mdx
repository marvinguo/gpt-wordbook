...
<WordRelations
  synonyms={["destroying", "ruining", "spoiling", "deterioration", "worsening", "adulteration", "contamination", "debasement", "defilement", "dirtying", "soiling", "tainting", "bribery", "depravity", "impurity", "wickedness", "bastardization", "erosion", "rent-seeking", "decay"]}
  client:only
/>
