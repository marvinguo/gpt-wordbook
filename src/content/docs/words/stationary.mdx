...
<WordRelations
  synonyms={["immobile", "unmoveable", "fixed", "motionless", "still", "stock-still", "unmoving", "changeless", "constant", "immutable", "unchanging"]}
  antonyms={["mobile", "moveable", "in motion", "moving", "on the move", "changing", "mutable", "variable"]}
  client:only
/>
