...
<WordRelations
  synonyms={["ensue", "pursue", "tail", "trail", "succeed", "undermentioned", "succeeding"]}
  antonyms={["guide", "lead", "precede", "unfollow", "abovementioned", "aforementioned", "aforesaid", "preceding"]}
  client:only
/>
